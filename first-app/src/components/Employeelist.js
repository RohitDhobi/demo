...
const Employeelist = () => {
  ...
  return (
    <div className='container mx-60 my-8'>
      <div>
        <button onClick={ ()=> navigate("/addEmployee") } className='bg-slate-600 hover:bg-blue-700 my-12 px-20 py-2 rounded font-semibold'>Add Employees</button>
      </div>
      <div>
        <table className='shadow'>
          ...
          <tbody>
            ...
            <tr className='hover:bg-white hover:text-black'>
              <td key={employee.id} className='text-left px-6 py-4 whitespace-nowrap'>{employee.id}</td>
